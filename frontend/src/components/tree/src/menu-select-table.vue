...
import { Alert, Checkbox, RadioGroup, Space, Button } from 'ant-design-vue';
  ...
  <div class="flex h-full flex-col" id="menu-select-table">
    <BasicTable>
      <template #toolbar-actions>
        <RadioGroup v-model:value="association" :options="nodeOptions" button-style="solid" option-type="button"
      ...
      <template #permissions="{ row }">
        <div class="flex flex-wrap gap-x-3 gap-y-1">
          <Checkbox v-for="permission in row.permissions" :key="permission.id" v-model:checked="permission.checked"
