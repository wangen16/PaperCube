...
import { Card, Skeleton, TabPane, Tabs, Button } from 'ant-design-vue';
...
<template>
  <Page :auto-content-height="true">
    <Card class="h-full" v-if="genInfoData" :body-style="{ padding: '0 16px 16px' }">
      <Tabs v-model:active-key="currentTab" size="middle">
        <template #rightExtra>
          <!-- 因为编辑表格判断点击单元格之外的元素会取消编辑状态，此时需要事件拦截 -->
          <Button class="vxe-table--ignore-clear" type="primary" @click="handleSave">
            保存配置
          </Button>
        </template>
