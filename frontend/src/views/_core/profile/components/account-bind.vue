...
import { Alert, Avatar, Card, Empty, Modal, Tooltip, Button } from 'ant-design-vue';
...
<template>
  <div class="flex flex-col gap-4 pb-4">
    <div v-if="bindList.length > 0" class="grid grid-cols-1 gap-4 lg:grid-cols-2 2xl:grid-cols-3">
      <Card class="transition-shadow duration-300 hover:shadow-md" v-for="item in bindList" :key="item.source">
        <div class="flex w-full items-center gap-4">
          ...
          <div class="flex flex-1 items-center justify-between">
            ...
            <!-- TODO: 这里有优化空间? -->
            <Button size="small" :type="item.bound ? 'default' : 'link'" @click="
    ...
    <div v-if="bindList.length === 0" class="flex items-center justify-center rounded-lg border py-4">
