...
import { Modal, Popconfirm, RadioGroup, Space, Button } from 'ant-design-vue';
    ...
    <div class="flex h-full gap-[8px]">
      ...
      <BasicTable class="flex-1 overflow-hidden">
        <template #toolbar-actions>
          <RadioGroup v-model:value="currentType" :options="typeOptions" button-style="solid" option-type="button"
        ...
        <template #action="{ row }">
          <div class="flex flex-col">
            <div v-if="currentType === 'process_running'">
              <Button danger size="small" type="link" @click.stop="handleInvalid(row)">
                作废流程
              </Button>
            ...
            <div>
              <Button size="small" type="link" @click.stop="handleInfo(row)">
                流程预览
              </Button>
              <Button size="small" type="link" @click.stop="handleVariable(row)">
                变量查看
              </Button>
            </div>
          </div>
