  ...
  <div class="workflow-designer-root">
    ...
    <div class="workflow-sider" :class="{ collapsed: siderCollapsed }">
      <div class="sider-header">
        ...
        <Button size="small" type="text" class="collapse-toggle" @click="siderCollapsed = !siderCollapsed">
      ...
      <div class="component-list">
        <template v-for="component in wfComponents" :key="component.name">
          <div v-if="component.isEnable !== false" class="component-item" :draggable="true"
            @dragstart="onPaletteDragStart($event, component.name)">
            <div class="component-icon">
              <SvgIcon :class="getIconClassByComponentName(component.name)"
    ...
    <div class="workflow-canvas-container" @drop="onDrop" @dragover="onDragOver">
      <VueFlow ref="wrapper" :nodes="uiWorkflow.nodes" :edges="uiWorkflow.edges" :node-types="nodeTypes"
        :edge-types="edgeTypes" fit-view-on-init class="workflow-canvas">
        <Background />
      </VueFlow>
      <RightPanel :workflow="props.workflow" :ui-workflow="uiWorkflow" :hide-property-panel="hidePropertyPanel"
        :wf-node="selectedWfNode" />
      <div class="canvas-toolbar">
        <Button :disabled="props.saving" class="toolbar-btn toolbar-btn-default" @click="onRun">运 行</Button>
        <Button :disabled="props.saving" :loading="props.saving" type="primary" class="toolbar-btn" @click="onSave">保
          存</Button>
      </div>
    </div>
  </div>
